...
####Console Output:
```Console  
@mint64 ~/Programming/Meteor/LevelUpTuts/Monthly_Resolutions/resolutions_Original $ meteor create resolutions
...
@mint64 ~/Programming/Meteor/LevelUpTuts/Monthly_Resolutions/resolutions_Original $ cd resolutions/
@mint64 ~/Programming/Meteor/LevelUpTuts/Monthly_Resolutions/resolutions_Original/resolutions $ ls -hal
total 28K
...
@mint64 ~/Programming/Meteor/LevelUpTuts/Monthly_Resolutions/resolutions_Original/resolutions $ meteor
[[[[[                                         
